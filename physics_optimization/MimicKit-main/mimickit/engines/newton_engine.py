...
class NewtonEngine(engine.Engine):
    def __init__(self, config, num_envs, device, visualize):
        ...
        self._ground_mu = config.get("ground_mu", 1.0)
    ...
    def _create_model_builder(self):
        ...
        builder.default_shape_cfg.mu = self._ground_mu
        return builder
    ...
    def _build_ground(self):
        shape_cfg = self._scene_builder.ShapeConfig(mu=self._ground_mu,
                                                    restitution=self._ground_restitution)
